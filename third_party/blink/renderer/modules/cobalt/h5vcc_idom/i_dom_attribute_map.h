...
class IDomAttributeMap final : public ScriptWrappable {
 ...
 public:
  ...
  V8AttrMutator* defaultValue() const { return default_value_; }
  void setDefaultValue(V8AttrMutator* mutator) { default_value_ = mutator; }

  V8AttrMutator* style() const { return style_; }
  void setStyle(V8AttrMutator* mutator) { style_ = mutator; }
